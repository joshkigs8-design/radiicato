...
export default function SingleCollectionPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Banner */}
      <section className="relative min-h-[55vh] sm:min-h-[65vh] flex items-end pb-16 px-6 sm:px-12 pt-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1600px] w-full mx-auto space-y-6">
          <Link
            href="/collections"
            className="inline-flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-zinc-300 hover:text-white transition-colors"
          >
            <ArrowLeft size={14} /> Back to All Collections
          </Link>

          <div className="max-w-3xl space-y-4">
            <span className="text-[11px] font-mono tracking-[0.3em] uppercase text-[#A6C091] block font-bold">
              CAPSULE SERIES
            </span>
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black uppercase tracking-tight text-white font-display">
              {collection.name}
            </h1>
            <p className="text-sm sm:text-base text-zinc-200 font-light leading-relaxed max-w-xl">
          ...
          {collection.isScheduled && (
            <div className="p-6 bg-black/80 backdrop-blur-md border border-white/20 max-w-md mt-6 space-y-3 shadow-xl">
              <div className="flex items-center justify-between">
                <span className="text-xs font-mono uppercase tracking-widest text-[#A6C091] flex items-center gap-2 font-bold">
              ...
              <div className="grid grid-cols-4 gap-2 text-center pt-2">
                <div className="bg-white/10 backdrop-blur-sm p-2.5 border border-white/10">
      ...
      <section className="py-20 px-6 sm:px-12 max-w-[1600px] mx-auto">
        <div className="flex justify-between items-center pb-8 border-b border-[#E4E4E7] mb-12">
          ...
          <span className="text-xs font-mono text-[#4D5936] font-bold">ORIGINAL ARCHIVAL GARMENTS</span>
        </div>
