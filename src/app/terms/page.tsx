    ...
    <main className="pt-28 sm:pt-36 pb-32 px-5 sm:px-8 lg:px-12 bg-white min-h-screen">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-[10px] text-[#71717A] font-mono uppercase tracking-[0.2em] mb-12 pb-10 border-b border-[#E4E4E7]">
          OPERATED BY PESOS WORLDWIDE • GLOBAL STREETWEAR LABEL
        </p>
        ...
        <div className="space-y-8 text-sm text-[#71717A] leading-relaxed">
          <section className="space-y-3">
            ...
            <p>
              By accessing or ordering from the PESOS Worldwide digital storefront, you agree to be bound by these Terms and Conditions. PESOS Worldwide reserves the right to decline or cancel orders if inventory discrepancies or fraud indicators occur.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              All prices listed on the storefront are denominated in the selected checkout currency and may vary by market and payment method. We reserve the right to amend pricing prior to order confirmation.
            </p>
          </section>
